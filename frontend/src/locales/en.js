export const en = {
  ...
  statistics: {
    ...
    items: [
      { number: "50+", label: "Workers Placed" },
  ...
  about: {
    ...
    values: [
      { title: "Quality", description: "Excellence in every placement" },
      { title: "Trust", description: "Building lasting relationships" },
      { title: "Innovation", description: "Modern solutions for modern needs" },
      { title: "Support", description: "Dedicated service every step" }
    ]
  },
  contact: {
    title: "Get in Touch",
    ...
    cta: "Contact Us Now",
    companyFormTitle: "For Companies",
    companyFormSubtitle: "Looking for qualified workers?",
    workerFormTitle: "For Workers",
    workerFormSubtitle: "Looking for construction work?",
    formLabels: {
      name: "Full Name",
      email: "Email",
      phone: "Phone",
