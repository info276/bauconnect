export const sk = {
  ...
  about: {
    ...
    values: [
      { title: "Kvalita", description: "Excelentnosť v každom umiestnení" },
      { title: "Dôvera", description: "Budovanie trvalých vzťahov" },
      { title: "Inovácia", description: "Moderné riešenia pre moderné potreby" },
      { title: "Podpora", description: "Venovaná služba v každom kroku" }
    ]
  },
  contact: {
