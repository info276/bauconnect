        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center p-6 bg-slate-700/50 rounded-xl hover:bg-slate-700 transition-colors">
              ...
              <a href={`mailto:${t.contact.email}`} className="text-slate-300 text-sm hover:text-orange-500 transition-colors">{t.contact.email}</a>
            </div>
            <div className="flex flex-col items-center p-6 bg-slate-700/50 rounded-xl hover:bg-slate-700 transition-colors">
              <Phone className="w-12 h-12 text-orange-500 mb-4" />
              <h4 className="font-semibold mb-2">{t.contact.labels.phone}</h4>
              <a href={`tel:${t.contact.phone}`} className="text-slate-300 text-sm hover:text-orange-500 transition-colors">{t.contact.phone}</a>
            </div>
            <div className="flex flex-col items-center p-6 bg-slate-700/50 rounded-xl hover:bg-slate-700 transition-colors">
