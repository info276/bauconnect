    ...
    <div className="min-h-screen bg-slate-50 py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-800 mb-4">Úplné znenie zásad</h2>
            <p className="text-slate-700 mb-4">
              Pre podrobné informácie o ochrane osobných údajov si môžete stiahnuť úplné znenie našich zásad:
            </p>
            <a 
              href="/zasady-ochrany-osobnych-udajov.pdf" 
              target="_blank"
